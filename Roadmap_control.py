...
def make_control(args):
    dcols = ['DNase.union','DNase.sum','H3K4me1.union','H3K4me1.sum','H3K4me3.union','H3K4me3.sum','H3K9ac.union','H3K9ac.sum','H3K27ac.union','H3K27ac.sum','H3K36me3.union','H3K36me3.sum']
   ...
   chrom = args.chrom
    ...
    for s in fnames:
        ...
        dfs.append(pd.read_csv(annot_dir+'Roadmap.'+s+'.'+chrom+'.annot.gz', delim_whitespace=True)['ANNO'])
    sampledf = dfs[0].iloc[:,:4]
